...
define('DOMAIN_URL', 'https://bharat.greymatterworks.in/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_bharat";  // Change as required
    private $db_pass = "Bharat@2022";  // Change as required
    private $db_name = "u743445510_bharat";    // Change as required
